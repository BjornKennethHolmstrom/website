...
[Besök den officiella hemsidan](https://www.fjarilspartiet.se)

## Ett parti för systemisk samhällsförnyelse

![](images/fjarilsagg.png)

_Vi befinner oss i äggstadiet - en tid av omsorgsfull utveckling och förberedelse_
...
- Besök [den officiella hemsidan](https://fjarilspartiet.se/bli-medlem) och fyll i formuläret med:

1. Ditt namn och kontaktinformation

3. Gärna några ord om ditt intresse för partiet

5. Klicka knappen för att skicka ansökan

- Som medlem får du viktiga uppdateringar om partiets utveckling

- Inga medlemsavgifter krävs – vi växer tillsammans genom frivilliga bidrag och gemensamma initiativ.
...
🔗 **Digital åtkomst till partiets dokument**:

- [Google Drive](https://tinyurl.com/fjarilspartiets-dokument)

- [GitHub](https://github.com/fjarilspartiet-se/fjarilspartiet/tree/main/public/docs)

### Digital infrastruktur

Våra demokratiska processer stöds av [DPOP (Digital Party Operations Platform)](https://github.com/fjarilspartiet-se/DPOP), en öppen plattform utformad för flexibelt och säkert demokratiskt deltagande. DPOP möjliggör vår adaptiva styrningsmodell och säkerställer transparent, tillgängligt engagemang för alla medlemmar.
...
Discord: [https://discord.gg/GxSxaYANU4](https://discord.gg/GxSxaYANU4)

📧 fjarilspartiet@gmail.com

* * *

_Fjärilspartiet - Systemisk förnyelse för en blomstrande framtid_
