...
/**
 * Generate PDF for the Bhutan Interface Race report
 *
 * Usage: node scripts/generate-bhutan-report-pdf.js [language]
 * Example: node scripts/generate-bhutan-report-pdf.js en
 *
 * Requirements:
 * npm install marked puppeteer katex
 *
 * Notes:
 *   - Only English is generated for now. When a Dzongkha translation becomes
 *     available, add 'dz' to VALID_LANGUAGES, add a 'dz' entry to `metadata`,
 *     add `titleDz` to each section, and map the -dz.md filenames.
 */
...
const REPORT_SLUG = 'bhutan-interface-race';
...
const metadata = {
	en: {
		title: 'Bhutan: The Interface Race',
		subtitle: 'Objective–Actuator Coupling Under Acceleration',
		description:
		...
		date: 'September 2026',
		url: 'https://bjornkennethholmstrom.org/reports/bhutan-interface-race',
		license: 'Creative Commons Attribution-ShareAlike 4.0 International',
		type: 'Country Report · Bhutan'
	}
};
...
const sections = [
	{ file: '00-executive-summary',              titleEn: 'Executive Summary',                                            isAppendix: false },
	{ file: '01-the-interface-race',             titleEn: '1. The Interface Race',                                        isAppendix: false },
	{ file: '02-structural-mechanisms',          titleEn: '2. The Interface Race: Structural Mechanisms',                 isAppendix: false },
	{ file: '03-building-interface-capacity',    titleEn: '3. What Building Interface Capacity Would Look Like',          isAppendix: false },
	{ file: '04-what-slows-interface-building',  titleEn: '4. What Slows Interface Building',                             isAppendix: false },
	{ file: '05-transition-architecture',        titleEn: '5. Working with the Grain: Transition Architecture for Bhutan', isAppendix: false },
	{ file: '06-first-step',                     titleEn: '6. A Concrete First Step: The Actuator Interface Register',    isAppendix: false },
	{ file: '07-coda',                           titleEn: '7. Coda: The Keeper of the Whole at the Frontier of Speed',    isAppendix: false },
	{ file: '08-appendix-a',                     titleEn: 'Appendix A: Value Systems and Policy Mindsets',                isAppendix: true  },
	{ file: '08-appendix-b',                     titleEn: 'Appendix B: International Analogues and Precedents',           isAppendix: true  },
	{ file: '08-appendix-c',                     titleEn: 'Appendix C: The Governance as Engineering Connection',         isAppendix: true  },
	{ file: '08-appendix-d',                     titleEn: 'Appendix D: Anticipated Objections',                           isAppendix: true  },
	{ file: '08-appendix-e',                     titleEn: 'Appendix E: About the Author and Method',                      isAppendix: true  },
	{ file: '08-appendix-f',                     titleEn: 'Appendix F: The Crypto–Pay Case File',                         isAppendix: true  },
	{ file: '08-appendix-g',                     titleEn: 'Appendix G: The Gelephu Mindfulness City — Legal and Accountability Architecture', isAppendix: true }
];
...
async function main() {
	try {
		console.log('📄 Starting PDF generation for Bhutan Interface Race report...\n');
