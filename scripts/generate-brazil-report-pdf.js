...
/**
 * Generate PDF for the Brazil Accumulation Deficit report
 * 
 * Usage: node scripts/generate-brazil-report-pdf.js [language]
 * Example: node scripts/generate-brazil-report-pdf.js en
 * Example: node scripts/generate-brazil-report-pdf.js pt_br
 * 
 * Requirements:
...
const VALID_LANGUAGES = ['en', 'pt_br'];
...
const REPORT_SLUG = 'brazil-accumulation-deficit';
...
// ── Section definitions ──────────────────────────────────────────────────────
const sections = [
    { file: '00-executive-summary',                   titleEn: 'Executive Summary',                                           titlePt: 'Sumário Executivo',                                                        isAppendix: false },
    { file: '01-accumulation-deficit',                 titleEn: '1. The Accumulation Deficit',                                 titlePt: '1. O Déficit de Acumulação',                                              isAppendix: false },
    { file: '02-capture-equilibrium',                  titleEn: '2. The Capture Equilibrium: A New Diagnosis',                  titlePt: '2. O Equilíbrio de Captura: Um Novo Diagnóstico',                         isAppendix: false },
    { file: '03-building-accumulation-capacity',       titleEn: '3. What Building Accumulation Capacity Looks Like',            titlePt: '3. Como Construir a Capacidade de Acumulação',                           isAppendix: false },
    { file: '04-political-immune-system',              titleEn: '4. The Political Immune System',                              titlePt: '4. O Sistema Imunológico Político',                                      isAppendix: false },
    { file: '05-transition-architecture',              titleEn: '5. Working with the Grain: Transition Architecture for Brazil', titlePt: '5. Trabalhando com a Estrutura: Arquitetura de Transição para o Brasil', isAppendix: false },
    { file: '06-first-step',                           titleEn: '6. A Concrete First Step: The Algorithmic Bypass and Municipal Laboratories', titlePt: '6. Um Primeiro Passo Concreto: O Bypass Algorítmico e os Laboratórios Municipais', isAppendix: false },
    { file: '07-coda',                                 titleEn: '7. Coda: From Breakthrough-Capture to Breakthrough-Compound',  titlePt: '7. Coda: Da Captura de Avanços à Composição de Avanços',                isAppendix: false },
    { file: '08-appendix-a',                           titleEn: 'Appendix A: Value Systems & Policy Mindsets',                  titlePt: 'Apêndice A: Sistemas de Valores e Mentalidades Políticas',               isAppendix: true  },
    { file: '08-appendix-b',                           titleEn: 'Appendix B: International Analogues & Precedents',             titlePt: 'Apêndice B: Analogias Internacionais e Precedentes',                     isAppendix: true  },
    { file: '08-appendix-c',                           titleEn: 'Appendix C: The Governance as Engineering Connection',         titlePt: 'Apêndice C: A Conexão com a Série Governance as Engineering',            isAppendix: true  },
    { file: '08-appendix-d',                           titleEn: 'Appendix D: Anticipated Objections',                         titlePt: 'Apêndice D: Objeções Antecipadas',                                       isAppendix: true  },
    { file: '08-appendix-e',                           titleEn: 'Appendix E: About the Author & Method',                      titlePt: 'Apêndice E: Sobre o Autor e o Método',                                   isAppendix: true  },
];
...
function readMarkdownFiles() {
    ...
    for (const section of sections) {
        ...
        const title = LANGUAGE === 'pt_br' ? section.titlePt : section.titleEn;
...
async function main() {
    try {
        console.log('📄 Starting PDF generation for Brazil Accumulation Deficit report...\n');
