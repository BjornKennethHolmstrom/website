...
const chapters = {
  en: [
    ...
    { file: 'chapter-4',  title: '4. The Other Half of the Loop' },
    { file: 'chapter-5',  title: '5. The Third Question: Which System?' },
    { file: 'chapter-6',  title: '6. The Paradox of Competent Blindness' },
    { file: 'chapter-7',  title: '7. The Variety Gap' },
    { file: 'chapter-8',  title: '8. Why Failures Compound (And Why Reforms Disappoint)' },
    { file: 'chapter-9',  title: '9. The Meta‑Governance Imperative' },
    { file: 'chapter-10', title: '10. The Fragments Are Already Here' },
    { file: 'chapter-11', title: '11. A Sensory Prosthesis: What AI Could Be For' },
    { file: 'chapter-12', title: '12. The Shared Mirror' },
    { file: 'chapter-13', title: '13. The Civilizational Bet' },
    { file: 'chapter-14', title: '14. The Invitation' },
  ...
  sv: [
    ...
    { file: 'chapter-4-sv',  title: '4. Den andra halvan av loopen' },
    { file: 'chapter-5-sv',  title: '5. Den tredje frågan: Vilket system?' },
    { file: 'chapter-6-sv',  title: '6. Paradoxen med kompetent blindhet' },
    { file: 'chapter-7-sv',  title: '7. Varietetsgapet' },
    { file: 'chapter-8-sv',  title: '8. Varför misslyckanden förvärras' },
    { file: 'chapter-9-sv',  title: '9. Meta‑styrningsimperativet' },
    { file: 'chapter-10-sv', title: '10. Fragmenten finns redan här' },
    { file: 'chapter-11-sv', title: '11. En sensorisk protes: Vad AI skulle kunna vara till för' },
    { file: 'chapter-12-sv', title: '12. Den gemensamma spegeln' },
    { file: 'chapter-13-sv', title: '13. Det civilisatoriska vadet' },
    { file: 'chapter-14-sv', title: '14. Inbjudan' },
