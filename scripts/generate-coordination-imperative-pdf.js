...
const INPUT_FILE = path.join(CONTENT_DIR, `the-coordination-imperative-v0.1${suffix}.md`);
const OUTPUT_FILE = path.join(OUTPUT_DIR, `The-Coordination-Imperative-v0.1${suffix}.pdf`);
