...
/**
 * Generate PDF for the Nigeria Substrate Deficit report
 *
 * Usage: node scripts/generate-nigeria-report-pdf.js
 *
 * Requirements:
...
// ── Configuration ────────────────────────────────────────────────────────────
const LANGUAGE = 'en';  // English only for Nigeria
const REPORT_SLUG = 'nigeria-substrate-deficit';
...
const metadata = {
    en: {
        title: "The Substrate Deficit",
        subtitle: "A field guide to the Extraction–Dissociation–Adaptation–Crisis Loop — and how Africa’s most populous nation can build the institutional foundations its informal genius already assumes",
        description: "Nigeria is not a failed state — it is a hyper-governed society where the real governance of daily life occurs through informal networks the formal state neither controls nor acknowledges. This report diagnoses a Substrate Deficit produced by the petrostate fiscal architecture, the extraction coalition, and a cultural operating system that converts public office into private patrimony.",
        author: "Björn Kenneth Holmström",
        date: "May 2026",
        url: "https://bjornkennethholmstrom.org/reports/nigeria-substrate-deficit",
        license: "Creative Commons Attribution-ShareAlike 4.0 International",
        type: "Country Report · Nigeria"
    }
};
...
const sections = [
    ...
    { file: '01-substrate-deficit',            title: '1. The Substrate Deficit',                                     isAppendix: false },
    { file: '02-structural-mechanisms',        title: '2. The Substrate Deficit: Structural Mechanisms',               isAppendix: false },
    { file: '03-building-governance-substrate',title: '3. What Building Governance Substrate Would Look Like',         isAppendix: false },
    { file: '04-political-immune-system',      title: '4. The Political Immune System: The Extraction Coalition',      isAppendix: false },
    { file: '05-transition-architecture',      title: '5. Working with the Grain: Transition Architecture for Nigeria',isAppendix: false },
    { file: '06-first-step',                   title: '6. A Concrete First Step: The Fiscal Accountability Compact and the Demography-Climate Commission', isAppendix: false },
    { file: '07-coda',                        title: '7. Coda: The Post-Westphalian Prototype — or the Pre-Westphalian Warning', isAppendix: false },
...
async function main() {
    try {
        console.log('📄 Starting PDF generation for Nigeria Substrate Deficit report...\n');
