 ...
 * Example: node scripts/generate-requisite-variety-commons-pdf.js sv
 *
 * Requirements:
...
const sections = [
	{ file: 'executive-summary', isAppendix: false },
	{ file: 'part-1',            isAppendix: false },
	{ file: 'part-2',            isAppendix: false },
	{ file: 'part-3',            isAppendix: false },
	{ file: 'part-4',            isAppendix: false },
	{ file: 'part-5',            isAppendix: false },
	{ file: 'part-6',            isAppendix: false },
	{ file: 'part-7',            isAppendix: false },
	{ file: 'appendix-a',        isAppendix: true  },
	{ file: 'appendix-b',        isAppendix: true  },
	{ file: 'appendix-c',        isAppendix: true  },
];
...
<style>
	...
	.appendix, .references { page-break-before: always; }
...
function readMarkdownFiles() {
	...
	for (const section of sections) {
		...
		contents.push({ content, isAppendix: section.isAppendix });
	}
...
`;
	...
	sections.forEach((section, index) => {
		...
		html += marked.parse(enhancedContent);
		html += `</section>\n`;
	});
...
async function main() {
	try {
		console.log('📄 Starting PDF generation for Requisite Variety and the Commons...\n');
		...
		if (process.env.DEBUG) {
			const debugFile = path.join(__dirname, `../debug-requisite-variety-${LANGUAGE}.html`);
