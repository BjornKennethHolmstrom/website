...
/**
 * Generate PDF for the Russia Legibility Deficit report
 * 
 * Usage: node scripts/generate-russia-report-pdf.js [language]
 * Example: node scripts/generate-russia-report-pdf.js en
 * Example: node scripts/generate-russia-report-pdf.js ru
 * 
 * Requirements:
...
const REPORT_SLUG = 'russia-legibility-deficit';
...
const metadata = {
    en: {
        ...
        subtitle: "A boundary case for the Country Reports for Systemic Change — and what Russia reveals about the limits of adaptive governance",
        description: "Russia is not another failure mode — it is a different category of system. This boundary case diagnoses a Legibility Deficit in an architecture that makes accurate perception a threat to its own survival, and reveals the limits of adaptive governance.",
        author: "Björn Kenneth Holmström",
        date: "May 2026",
        url: "https://bjornkennethholmstrom.org/reports/russia-legibility-deficit",
        license: "Creative Commons Attribution-ShareAlike 4.0 International",
        type: "Boundary Case · Russia"
    },
    ru: {
        title: "Дефицит читаемости: Когда архитектура управления уничтожает возможность управлять",
        subtitle: "Граничный случай для серии «Страновые доклады о системных изменениях» — и что Россия показывает о пределах адаптивного управления",
        description: "Россия — это не очередной вид дисфункции, а иная категория системы. Этот граничный случай диагностирует дефицит читаемости в архитектуре, которая превращает точное восприятие в угрозу собственному существованию, и раскрывает границы адаптивного управления.",
        author: "Бьорн Кеннет Хольмстрём",
        date: "Май 2026",
        url: "https://bjornkennethholmstrom.org/reports/russia-legibility-deficit",
        license: "Creative Commons Attribution-ShareAlike 4.0 International",
        type: "Граничный случай · Россия"
    }
};
...
// ── Section definitions ──────────────────────────────────────────────────────
const sections = [
    { file: '00-executive-summary',    titleEn: 'Executive Summary',                                          titleRu: 'Аннотация',                                                                 isAppendix: false },
    { file: '01-legibility-deficit',   titleEn: '1. The Legibility Deficit',                                  titleRu: '1. Дефицит читаемости',                                                      isAppendix: false },
    { file: '02-structural-mechanisms', titleEn: '2. The Structural Mechanisms',                               titleRu: '2. Структурные механизмы',                                                   isAppendix: false },
    { file: '03-reform-is-impossible',  titleEn: '3. Why Reform Is Impossible Under the Current Regime — and What Might Follow', titleRu: '3. Почему реформы невозможны при текущем режиме — и что может последовать', isAppendix: false },
    { file: '04-dark-mirror',           titleEn: '4. Coda: The Dark Mirror',                                  titleRu: '4. Кода: Тёмное зеркало',                                                    isAppendix: false },
    { file: '05-appendix-a',            titleEn: 'Appendix A: Value Systems & Policy Mindsets',                titleRu: 'Приложение A: Системы ценностей и политические установки',                  isAppendix: true  },
    { file: '05-appendix-b',            titleEn: 'Appendix B: The Governance as Engineering Connection',       titleRu: 'Приложение B: Связь с Governance as Engineering',                            isAppendix: true  },
    { file: '05-appendix-c',            titleEn: 'Appendix C: About the Author & Method',                     titleRu: 'Приложение C: Об авторе и методе',                                           isAppendix: true  },
];
...
function readMarkdownFiles() {
    ...
    for (const section of sections) {
        ...
        const title = LANGUAGE === 'ru' ? section.titleRu : section.titleEn;
...
async function main() {
    try {
        console.log('📄 Starting PDF generation for Russia Legibility Deficit report...\n');
