...
/**
 * Generate PDF for the UK Control Mirage report
 * 
 * Usage: node scripts/generate-uk-report-pdf.js [language]
...
const REPORT_SLUG = 'uk-control-mirage';
...
const metadata = {
    en: {
        title: "The Control Mirage",
        subtitle: "A field guide to the control-delivery mismatch — and how the UK can place power where reality actually is",
        description: "The UK does not lack ambition — it lacks the ability to place control where reality actually is. This report diagnoses a control-delivery mismatch produced by administrative hollowing, the Treasury trap, and the English Question, and proposes Trailblazer Regions 2.0 as the concrete first step.",
        author: "Björn Kenneth Holmström",
        date: "May 2026",
        url: "https://bjornkennethholmstrom.org/reports/uk-control-mirage",
        license: "Creative Commons Attribution-ShareAlike 4.0 International",
        type: "Country Report · United Kingdom"
    }
};
...
const sections = [
    ...
    { file: '01-control-mirage',            title: '1. The Control Mirage' },
    { file: '02-diagnosis',                 title: '2. The Control-Delivery Mismatch: A New Diagnosis' },
    { file: '03-building-alignment',        title: '3. What Building Control-Delivery Alignment Would Look Like' },
    { file: '04-political-immune-system',   title: '4. The Political Immune System: Why the UK Centralises' },
    { file: '05-transition-architecture',   title: '5. Working with the Grain: Transition Architecture for the UK' },
    { file: '06-trailblazer-2.0',          title: '6. A Concrete First Step: Trailblazer Regions 2.0' },
    { file: '07-coda',                      title: '7. Coda: From Centralising to Connecting' },
...
// ── CSS (identical to France/Sweden/India/EU scripts) ───────────────────────────
const pdfStyles = `
<style>
	@page {
		size: A4;
...
async function main() {
    try {
        console.log('📄 Starting PDF generation for UK Control Mirage report...\n');
