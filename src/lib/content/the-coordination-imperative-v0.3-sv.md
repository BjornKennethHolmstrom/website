...
Vi betalar redan för denna missanpassning. Vi betalar genom misshanterade pandemier, klimatpolitiska dödlägen, kollapsade leveranskedjor, överflödig forskning och regulatorisk fragmentering. Kalla det [**samordningsbortfallsskatten**](https://www.bjornkennethholmstrom.org/working-papers/coordination-failure-tax) (coordination failure tax) — den verkliga ekonomiska och mänskliga kostnaden för system som inte kan samordna på den skala som deras ömsesidiga beroende kräver. Enligt försiktiga uppskattningar uppgår den till biljoner dollar per kris. Vi saknar inte resurser. Vi saknar kapaciteten att samordna dem.

Här är något som den konventionella redovisningen av denna skatt missar: misslyckandena adderas inte. De multipliceras. En civilisation med fyra samtidiga samordningsbortfall — i sin finansiella styrning, sina hälsosystem, sin ekologiska förvaltning, sitt demokratiska samtal — opererar inte på noll kapacitet. Den opererar på ungefär sex procent av normalnivån, eftersom varje bortfall intensifierar trycket på de andra och förbrukar den reformkapacitet som skulle kunna åtgärda dem. Den sammansatta matematiken bakom samtidiga misslyckanden är en del av förklaringen till varför kostnaden för samordningsbortfall ständigt överträffar förväntningarna. Det är också en del av förklaringen till varför lösningarna känns så ihärdigt utom räckhåll.
...
Det finns en sak till som den korta versionen måste säga, eftersom varje tidigare version har undvikit det: anledningen till att bättre samordning inte har byggts är i första hand varken okunskap eller teknisk svårighet. Det är att de aktörer som har störst inflytande över institutionell utformning ofta är de aktörer som tjänar mest på den nuvarande ordningen. De institutioner som försvarar den befintliga arkitekturen misslyckas inte — utifrån perspektivet hos dem de tjänar fungerar de precis som avsett. Varje övergångsstrategi som inte tar hänsyn till detta kommer att absorberas av samma maskineri som den försöker förändra. Detta dokument försöker ta hänsyn till det.
...
Själva processen är en småskalig demonstration av tesen — och en demonstration av det diagnostiska ramverk som löper genom detta dokument. Serien av styrningsrapporter som låg till grund för denna revidering utformades för att undvika den resolutionsinlåsning (Resolution Lock-In) som plågar de institutioner den studerar: den opererade på flera skalor samtidigt, använde flera oberoende analytiska röster och utsatte medvetet varje analys för utmaningar från perspektiv med olika blinda fläckar. Processen producerade insikter som ingen enskild analytiker skulle ha nått på egen hand — vilket är argumentet för flerskalig, distribuerad observation inom styrning, bevisat i litet format. Om fem AI:n och en svensk kan komma så här långt, tänk vad som händer när resten av er ansluter.
...
Detta är version 0.3. Det är avsett att "forkas", översättas, kritiseras och skrivas om. Målet var aldrig att producera ett färdigt dokument. Målet var att ta fram en användbar utgångspunkt.
...
Innan frågan om *hur* man samordnar finns en föregående fråga: *för vad?*

Detta dokument kan inte svara på det. Men det kan ställa frågan tydligt — och att ställa den här, innan den tekniska diskussionen börjar, är ärligare än att stoppa undan den som en sent anländande filosofisk brasklapp.
...
Flera saker har sammanstrålat. Internet har gjort global samordning i realtid tekniskt genomförbar till en marginalkostnad nära noll — något som var fysiskt omöjligt under större delen av mänsklighetens historia. AI ökar komplexiteten och hastigheten hos systemrisker snabbare än institutioner hinner anpassa sig, vilket gör samordningsklyftan farligare för varje år som går. Globalt ömsesidigt beroende är inte längre en abstraktion; det är en upplevd verklighet för alla som har väntat på en försenad leverans, sett ett avlägset krig påverka bensinpriserna, eller burit munskydd på grund av ett virus som härstammar från en annan kontinent. Och kostnaden för bristande samordning är nu mätbar: biljoner per kris, miljontals liv, förvärrande ekologisk skada.

Men det finns något som brådskande inramningar vanligtvis utelämnar. Misslyckandena är inte oberoende av varandra. När det finansiella systemets samordning fallerar, förbrukar det det finanspolitiska utrymme som hälsosamordning kräver. När hälsosamordning fallerar, genererar det den ekonomiska störning som bryter ned den politiska stabilitet som klimatsamordning är beroende av. När ekologisk samordning fallerar, skapar det det resurstryck som intensifierar de konflikter som gör all annan samordning svårare. Kriserna adderas inte — de ackumuleras. Detta är ingen metafor. Det är den strukturella matematiken bakom samtidiga misslyckanden i ömsesidigt beroende system. Och det innebär att argumentet för att bygga bättre samordningsinfrastruktur inte enbart är att varje enskilt misslyckande är kostsamt. Det är att interaktionerna mellan misslyckanden gör allting värre snabbare än vad någon enskild domänrespons kan kompensera för.

Matematiken har förändrats. Frågan är inte längre om bättre samordning är önskvärd. Frågan är om vi bygger den medvetet eller fortsätter att betala för dess frånvaro genom katastrofer.

---

## Observationsproblemet: Varför institutioner är strukturellt blinda

Innan lösningen beskrivs är det värt att vara precis om problemet. Standardberättelsen — att institutioner designades för en enklare värld och inte hängt med — är sann så långt den räcker. Men den förklarar inte varför institutioner som vet att de misslyckas fortsätter att misslyckas. Den förklarar inte varför organisationer bemannade av briljanta, hängivna människor konsekvent missar kriser som retrospektiva analyser visar var helt förutsägbara. Och den förklarar inte varför reformansträngningar, hur väldesignade de än är, så ofta misslyckas med att åstadkomma varaktig förändring.

Det djupare svaret är observationellt. Varje styrande institution reducerar komplexiteten i den miljö den styr till en hanterbar uppsättning signaler — de mätetal den följer, de kategorier den erkänner, den data den samlar in. Denna komprimering är inte en brist. Den är en nödvändighet. Ingen institution kan bearbeta allt. Men komprimeringen är destruktiv: den information som utesluts från institutionens observationskanal upphör inte att existera. Den ackumuleras som en extern effekt, osynlig för institutionen, tills den tvingar sig in i synfältet genom kris.

Kalla detta **observationsgapet**: missanpassningen mellan vad institutionen kan se och vad som bestämmer de utfall den ska styra.

Observationsgapet är inte nytt. Vad som är nytt är dess skala och hastighet. Under större delen av institutionell historia var gapet hanterbart eftersom miljön förändrades tillräckligt långsamt för att kriser skulle ge tillräcklig förvarning innan de blev katastrofala, och institutioner kunde uppdatera sina observationskanaler mellan kriserna. Informationsrevolutionen har dramatiskt komprimerat denna anpassningsperiod. Problem rör sig nu från uppkomst till kris snabbare än institutionella reformcykler hinner slutföras. Den eftersläpning som en gång var hanterbar har blivit strukturellt destabiliserande.

Tre fellägen följer ur observationsgapet, och alla tre förekommer upprepade gånger inom de domäner där samordning fallerar.

**Genomsnittsproblemet.** När institutioner aggregerar lokal information till nationella eller globala indikatorer ser de medelvärdet men inte fördelningen. Ett nationellt genomsnitt som ser acceptabelt ut kan samexistera med regionala kriser i de omätta svansarna. En global indikator som visar förbättring kan maskera de specifika samhällen där förhållandena försämras snabbast. Politik som kalibreras efter genomsnittet blir systematiskt felkalibrerad till de platser där kriser koncentreras. Detta är inte inkompetens. Det är den strukturella konsekvensen av en observationskanal designad för att se genomsnitt.

**Hastighetsmissanpassningen.** Olika problem rör sig i olika hastigheter. Finansiell smitta rör sig i timmar. Pandemispridning rör sig i veckor. Ekologisk nedbrytning rör sig i årtionden. De flesta styrande institutioner opererar med en karakteristisk hastighet — hastigheten för sin policymcykel, sina rapporteringskrav, sin lagstiftningskalender. Problem som rör sig snabbare än denna hastighet är osynliga tills de överväldigar systemet. Problem som rör sig långsammare är synliga men politiskt svåra att upprätthålla uppmärksamhet kring över flera politiska cykler. Institutionen är inställd på en frekvens i en miljö som kräver respons över många.

**Problemet med den uteslutna dimensionen.** Varje institution observerar vissa dimensioner av det system den styr men inte andra. Centralbanker observerar inflation och produktion medan finansiell sårbarhet ackumuleras i de icke-övervakade dimensionerna. Hälsoministerier spårar sjukhuskapacitet medan de sociala bestämningsfaktorerna för nästa pandemi ackumuleras osynligt. Regleringsmyndigheter spårar dagens AI-förmågor medan anpassningsrisk (alignment risk) ackumuleras utanför deras mätningsarkitektur. Krisen inträffar, när den kommer, längs den uteslutna dimensionen — vilket är anledningen till att den alltid framstår som överraskande för institutionen, även när den var förutsägbar för observatörer som använde bredare observationskanaler.

Att förstå dessa fellägen förändrar vad bättre samordning kräver. Det är i första hand inte snabbare institutioner, eller bättre finansierade institutioner, eller ett mer hängivet ledarskap. Det är institutioner med observationskanaler vars dimensionalitet är adekvat för de system de styr — institutioner som kan se fördelningen, inte bara medelvärdet; hela frekvensspektrumet, inte bara sin föredragna hastighet; och de dimensioner som spelar roll, inte bara de dimensioner de historiskt har mätt.
...
När det internationella samfundet insåg klimatkrisens omfattning skapade man FN:s klimatpanel (IPCC – Intergovernmental Panel on Climate Change). Det betraktas allmänt som en framgång för global samordning. På grund av denna framgång föreslår beslutsfattare ofta att man ska skapa "ett IPCC för ojämlikhet", "ett IPCC för AI" eller "ett IPCC för global hälsa".
...
Implikationen är arkitektonisk: det globala samordningslagret måste vara tunt. Dess uppgift är inte att styra allt som är globalt betydelsefullt. Det är att styra den snäva uppsättning gemensamma fysiska system där kollektiv handling är den enda fungerande lösningen, och att tillhandahålla den informationsinfrastruktur som möjliggör bättre anpassad styrning på alla andra nivåer. Frestelsen att utöka det globala lagret – att centralisera mer, observera mer, styra mer – är den frestelse som de flesta samordningsmisslyckanden till slut faller för. Att motstå den är en designdisciplin, inte en politisk eftergift.

---

## Vad som förändras, vad som inte gör det

Om de föregående avsnitten beskrev vad samordningskapacitet är och hur det fungerar, tar det här avsnittet upp frågan som de flesta läsare faktiskt bryr sig om: vad betyder det för mig?

Börja med vad som inte förändras, eftersom den listan är lång och lugnande.

Du är fortfarande svensk, eller japan, eller texan, eller kenyan. Din nation styr fortfarande sig själv. Ditt samhälle fattar fortfarande sina egna beslut om utbildning, kultur, markanvändning och offentligt liv. Dina val spelar fortfarande roll. Dina traditioner är fortfarande dina. Lokal styrning förblir lokal – inte som ett tröstpris, utan för att hela arkitekturen är beroende av den. Ett samordningssystem som åsidosätter lokal kunskap motverkar sitt eget syfte.
...
### Immunsystemproblemet

Här måste dokumentet vara ärligt kring något som tidigare versioner har slätat över.

De institutioner som försvarar den befintliga arkitekturen misslyckas inte bara. Utifrån perspektivet hos dem de tjänar fungerar många av dem precis som avsett. De aktörer som tjänar på kostnadsexternalisering – utvinningsindustrier, vissa finansiella modeller, geopolitiska strategier som bygger på asymmetrisk makt – har starka intressen av att den nuvarande ordningen består. Och dessa aktörer har oproportionerligt inflytande över de institutionella former genom vilka samordningsförslag tas emot och bearbetas.

Detta är ingen konspiration. Det är det förutsägbara utfallet av en incitamentsarkitektur som belönar dem som drar nytta av status quo med resurser och inflytande att försvara det. Varje samordningsförslag hamnar i en institutionell miljö formad av dessa intressen. De förslag som hotar de mest lönsamma externaliseringarna möter det mest bestämda motståndet. Och motståndet tar vanligtvis inte formen av direkt opposition – det tar formen av absorption. Förslaget välkomnas, studeras, ändras, pilot-testas i en begränsad form, och oskadliggörs gradvis tills det inte längre hotar det underliggande arrangemanget. Reformens språk antas; reformens struktur gör det inte.

En övergångsstrategi som inte tar hänsyn till detta kommer att absorberas av samma maskineri som den försöker förändra. Designkravet är inte enbart att bygga bättre protokoll. Det är att bygga dem på sätt som är strukturellt svåra att absorbera – som skapar stödtrupper för den nya arkitekturen, som gör den gamla arkitekturens dysfunktion allt mer synlig och kostsam, och som utvidgar den politiska koalitionen för strukturell förändring snabbare än immunsystemet kan neutralisera den.

Konkret innebär detta tre saker. För det första: demonstrera värde i periferin innan man kräver anammande i centrum. Pilot-testa protokoll i villiga kommuner, villiga branscher, villiga nationer – och designa piloterna uttryckligen för att generera bevis som den omgivande arkitekturen inte lätt kan avfärda. För det andra: bygg förbifartsarkitekturer med solnedgångsvillkor. En förbifart som fungerar för bra avlastar trycket på den oreformerade kärnan, vilket låter kärnan överleva längre i sitt dysfunktionella tillstånd. Bra förbifartsdesign ökar trycket på kärnan snarare än att avlasta det: det kommunala laboratorium som producerar bättre resultat gör det nationella systemets dysfunktion mer synlig, inte mindre. För det tredje: utvidga den observationskanal som det politiska systemet använder för att utvärdera institutionell prestation. Immunsystemets mest kraftfulla försvar är att göra styrningsmisslyckanden osynliga – genom aggregerad statistik som döljer fördelningskonsekvenser, genom indikatorer kalibrerade till dimensioner där etablerade aktörer presterar väl, genom ansvarskedjor som är för långa för att spåra ansvarsskyldighet. Delad synlighet – den första pelaren i samordningskapacitet – är också det första kravet för att bygga politisk efterfrågan på strukturell förändring.

### Universell basinkomst som kognitiv infrastruktur

I en traditionell centraliserad institution är de mänskliga noderna – tjänstemän, administratörer, medborgare – fångade i en överlevnadsdynamik. Eftersom deras uppehälle beror på institutionen är deras primära incitament efterlevnad, inte anpassning. En nod har inte råd att utmana ett fallerande system om det hotar deras grundläggande överlevnad. Systemets kognitiva bandbredd förbrukas av institutionell självbevarelsedrift snarare än problemlösning.

För att uppgradera den föråldrade hårdvaran måste vi förändra fysiken i denna begränsning. Detta är ett strukturellt syfte med en universell basinkomst.

Ett garanterat inkomstgolv är inte bara en mekanism för fattigdomsbekämpning; det är en grundläggande kognitiv infrastruktur. Genom att frikoppla grundläggande överlevnad från institutionell lydnad sänks brusgolvet för överlevnadsångest – vilket frigör den intellektuella bandbredd som noder behöver för att faktiskt ta sig an komplexa problem istället för att hantera personliga risker. Mer precist: det rationella beteendet hos institutionella aktörer som inte har råd att utmana systemet är samma rationella beteende som gör immunsystem så effektiva. Att minska den personliga kostnaden för oliktänkande förändrar den incitamentsarkitektur som gör immunsystembeteende rationellt. I stor skala förändrar detta vad institutioner är kapabla att uppfatta och erkänna om sig själva.
...
1. **Lateral dirigering:** Att bygga horisontella kommunikationskanaler som kringgår långsamma vertikala hierarkier, vilket gör det möjligt för kommuner och lokalsamhällen att samordna sig direkt över jurisdiktionsgränser.
2. **Återkopplingsloopar med hög precision:** Att implementera lokala avkännings- och svarsmekanismer som flyttar beslutsfattandet till den nivå där den relevanta informationen finns – vilket neutraliserar genomsnittsproblemet inifrån.
3. **Omdirigering av resurser:** Att använda institutionens befintliga räckvidd – dess budgetar, juridiska ramverk, fysiska infrastruktur – och rikta in den mot resultat som institutionens formella mandat redan stöder, men som dess nuvarande arkitektur hindrar den från att uppnå.
...
Vi behöver inte en revolution för att navigera samordningskrisen. Vi behöver en samordnad firmware-uppdatering, utförd av suveräna noder inifrån – utformad med explicit hänsyn till de immunsystem som kommer att motsätta sig den, och strukturerad för att bygga politisk efterfrågan på strukturell förändring snarare än att bara demonstrera att förändring är möjlig.

---

## En inbjudan

Detta dokument slutar inte med en uppmaning till handling. Det finns ingen namninsamling att skriva under, ingen organisation att gå med i, ingen rörelse att ansluta sig till.

Det slutar med en inbjudan. Flera, faktiskt, beroende på vem du är.

Om du är en **tänkare** – en akademiker, en forskare, en policyanalytiker, någon som gillar att plocka isär idéer för att se hur de fungerar – är inbjudan att kritisera detta. Rigoröst. Hitta de bärande antagandena och testa dem. Stålmanna (steel-man) de starkaste invändningarna och se om ramverket överlever. Identifiera vad som saknas, vad som är naivt och vad som är fel. Det mest värdefulla du kan göra är att berätta för oss var detta brister. Och om du vill ha ett specifikt mål: hitta en domän där det tredelade mönstret – delad synlighet, lokalt genomförande, kostnad för avhopp – har implementerats fullt ut och har misslyckats med att producera samordning. Det är det falsifierande bevis som detta ramverk behöver möta.

Om du är en **byggare** – en ingenjör, en designer, en organisatör, någon som får saker att fungera i praktiken – är inbjudan att skapa prototyper. Välj ett samordningsmisslyckande i din domän – din stads vattenförvaltning, din branschs leveranskedja, ditt samhälles katastrofberedskap – och designa ett protokoll för det. Använd mönstret: delad synlighet, lokalt genomförande, kostnad för avhopp. Se om det fungerar. Rapportera tillbaka vad du lär dig. Och när du bygger en förbifart runt en dysfunktionell kärna, designa den med avsikt: inte bara för att fungera, utan för att göra kärnans dysfunktion obestridlig.
...
Och om du inte är något av detta – om du helt enkelt är någon som läste detta och fann det intressant – är inbjudan mindre men inte mindre viktig. Lägg märke till samordningsmisslyckanden när du stöter på dem. Nästa gång en institution misslyckas på ett sätt som känns förutsägbart och förebyggbart, fråga: vilket protokoll skulle göra detta onödigt? Vilken information skulle behöva delas? Vem skulle behöva agera lokalt? Vad skulle göra avhopp kostsamt? Och ställ också den svårare frågan: vems intressen tjänar det nuvarande arrangemanget, och vad skulle krävas för att de ska finna det nya arrangemanget mer attraktivt än det gamla? Du kanske upptäcker att det förändrar vad du ser om du tänker i dessa banor.
