export const coreTranslations = {
  ...
  light: 'LIGHT',
		...
		clusterPersonal: 'Personal Spaces',
		// Projects
  ...
  light: 'LJUS',
		// Hero
		title: 'Systemtänkare & Designer av medvetna system',
		mission:
		...
		// Clusters
		clusterSystems: 'Planetära & Samhälleliga system',
		clusterQuartet: 'Medvetandets kvartett',
		clusterPersonal: 'Personliga rum',
		// Projects
		ggfTitle: 'Global Governance Frameworks',
