export const coreTranslations = {
  ...
  reportsSwitzerlandTitle: 'Switzerland: The Boundary Expansion Deficit',
  reportsSwitzerlandTagline: 'When internal excellence meets global interdependence — why even near‑perfect governance can\'t match the world outside.',
  reportsSouthKoreaTitle: 'South Korea: The Tournament Trap',
  reportsSouthKoreaTagline: 'Why the world\'s most accomplished tournament must learn to need itself less.',
  reportsBhutanTitle: 'Bhutan: The Interface Race',
  reportsBhutanTagline: 'Why the country that knows best what it values must now build fast enough to keep it.',
  reportsNetherlandsTitle: 'Netherlands: The Feasibility Debt',
  reportsNetherlandsTagline: 'Why the country that taught the world to plan for an uncertain future sometimes commits to its own before securing it.',
  ...
  geCarouselSeries: {
    ...
    geSeriesPaperXIII: {
      title: 'XIII: Legitimacy as Emergent Gain',
      desc:  'Models legitimacy not as a political primitive but as an emergent coupling state — a gain parameter generated by the interaction between architecture and the governed. Introduces the legitimacy trap, the borrowed-vs-built distinction, and hysteresis dynamics. Bridges the series\' primitives to the outcomes they produce.',
    },
    geSeriesPaperXIV: {
  ...
  subsidiarityTagline: 'From centralized excellence to distributed resilience.',
		...
		janusTagline: 'Modeling human wholeness: Biological, cognitive, and spiritual.',
  stugaTitle: 'Stuga',
  stugaTagline: "Neighborhood resilience and resource coordination platform. Includes the Love Ledger protocol for local value exchange.",
  mycelTitle: 'Mycel',
  mycelTagline: "A coordination substrate for living communities. See who\'s around, what they offer, what they need — then go meet in person.",
  civicbaseTitle: 'CivicBase',
  civicbaseTagline: "(formerly CosmicSyncCore) Offline-first P2P infrastructure for civil defense and democratic continuity. Ensuring society keeps running when the internet doesn't.",
		cosmicTitle: 'CosmicSyncCore',
		cosmicTagline: 'P2P infrastructure for digital sovereignty and data privacy.',
		spheresTitle: 'SharedSpheres',
		spheresTagline: 'Prototype for integral social connection and growth.',
		spiralizeTitle: 'Spiralize.org',
		spiralizeTagline: 'Explore Spiral Dynamics and consciousness development.',
		nondualizeTitle: 'Nondualize.org',
		nondualizeTagline: 'Explore non-dual awareness and the nature of consciousness.',
		communizeTitle: 'Communize.org',
		communizeTagline: 'Explore community building and the creation of commons.',
		universalizeTitle: 'Universalize.org',
  ...
  // Contact page
		contact: {
			meta: {
				title: 'Contact | Björn Kenneth Holmström',
				description: 'Get in touch with Björn Kenneth Holmström. Share questions, reflections, or feedback.'
			},
			hero: {
				title: 'Get in Touch',
				subtitle: "Questions, reflections, or a simple 'hello'? I'd love to hear from you."
			},
			form: {
				name: 'Name',
				...
				errorMessage: 'Please try again or email me directly at bjorn.kenneth.holmstrom@gmail.com',
  ...
  reportsSwitzerlandTitle: 'Schweiz: Gränsutvidgningsunderskottet',
  reportsSwitzerlandTagline: 'När intern excellens möter globalt ömsesidigt beroende — varför även nästan perfekt styrning inte kan matcha omvärlden.',
  reportsSouthKoreaTitle: 'Sydkorea: Turneringfällan',
  reportsSouthKoreaTagline: 'Varför världens mest fulländade turnering måste lära sig att behöva sig själv mindre.',
  reportsBhutanTitle: 'Bhutan: Gränssnittsracet',
  reportsBhutanTagline: 'Varför landet som bäst vet vad det värderar nu måste bygga tillräckligt snabbt för att behålla det.',
  reportsNetherlandsTitle: 'Nederländerna: Genomförbarhetsskulden',
  reportsNetherlandsTagline: 'Varför landet som lärde världen planera för en osäker framtid ibland lovar sin egen innan den är säkrad.',
  ...
  geCarouselSeries: {
    ...
    geSeriesPaperXIII: {
      title: 'XIII: Legitimitet som emergent förstärkning',
      desc:  'Modellerar legitimitet inte som en politisk primitiv utan som ett emergent kopplingstillstånd — en förstärkningsparameter som genereras av interaktionen mellan arkitektur och de styrda. Introducerar legitimitetsfällan, distinktionen mellan lånad och byggd legitimitet, och hysteresdynamik. Överbryggar seriens primitiver till de utfall de producerar.',
    },
    geSeriesPaperXIV: {
  ...
  subsidiarityTagline: 'Från centraliserad excellens till distribuerad resiliens.',
		...
		janusTitle: 'Project Janus',
		janusTagline: 'Modellering av mänsklig helhet: Biologisk, kognitiv och andlig.',
  stugaTitle: 'Stuga',
  stugaTagline: "Plattform för grannskapens motståndskraft och resurssamordning. Inkluderar Love Ledger-protokollet för lokalt värdeutbyte.",
  mycelTitle: 'Mycel',
  mycelTagline: "Ett koordineringssubstrat för levande samhällen. Se vilka som finns i närheten, vad de erbjuder, vad de behöver — och träffas sedan på riktigt.",
  civicbaseTitle: 'CivicBase',
  civicbaseTagline: '(tidigare CosmicSyncCore) Offline-först P2P-infrastruktur för civilförsvar och demokratisk kontinuitet. Säkerställer att samhället fortsätter att fungera även när internet inte gör det.',
		cosmicTitle: 'CosmicSyncCore',
		cosmicTagline: 'P2P-infrastruktur för digital suveränitet och dataintegritet.',
		spheresTitle: 'SharedSpheres',
		spheresTagline: 'Prototyp för integral social gemenskap och utveckling.',
		spiralizeTitle: 'Spiralize.org',
		spiralizeTagline: 'Utforska Spiral Dynamics och medvetandeutveckling.',
		nondualizeTitle: 'Nondualize.org',
		nondualizeTagline: 'Utforska icke-dualitet och medvetandets natur.',
		communizeTitle: 'Communize.org',
		communizeTagline: 'Utforska gemenskap och skapandet av allmänningar.',
		universalizeTitle: 'Universalize.org',
  ...
  // Contact page
		contact: {
			meta: {
				title: 'Kontakt | Björn Kenneth Holmström',
				description: 'Kontakta Björn Kenneth Holmström. Dela frågor, reflektioner eller feedback.'
			},
			hero: {
				title: 'Hör av dig',
				subtitle: "Frågor, reflektioner, eller ett enkelt 'hej'? Jag vill gärna höra från dig."
			},
			form: {
				name: 'Namn',
				...
				successMessage: 'Tack för att du hörde av dig. Jag återkommer snart.',
				errorTitle: 'Något gick fel',
				errorMessage: 'Försök igen eller mejla mig direkt på bjorn.kenneth.holmstrom@gmail.com',
				sendAnother: 'Skicka ett till meddelande',
				tryAgain: 'Försök igen'
			},
			info: {
				title: 'Andra sätt att nå mig',
