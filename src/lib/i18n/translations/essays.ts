...
export const essaysTranslations = {
   ...
   cards: {
     ...
     wealthSystem: {
       ...
       subtitle: "Why Inequality is a Design Choice, Not an Accident",
       desc: "A systemic analysis of the mechanisms—rent-seeking, financialization, and tax havens—that concentrate wealth. Moving beyond the myth of meritocracy to the mechanics of redesign.",
       published: "May 2025",
   ...
   cards: {
     ...
     simulationTheory: {
       ...
       desc: "Fysik möter filosofi: Varför Gödels satser antyder att verkligheten inte är en dator, och varför vi måste bygga civilisation för de 'icke-beräknebara' aspekterna av varandet"
     },
     projectJanus: {
