---
title: Reclaim your keyboard! (and your fingers)
...
\[caption id="attachment\_media-88" align="alignnone" width="3984"\]![IMG_1892.JPG](/blog/2018-04-11-reclaim-the-keyboard-and-your-fingers/images/img_1892.jpg) _giving my mechanical keyboard the "DVORAK treatment"_\[/caption\]
...
The QWERTY layout grew out of necessity and convenience during the early stages of the typewriter. The top row of the layout has all the letters of typewrite, so that the salesperson could easily demonstrate the new invention. The letters had to be arranged in a way that the mechanical hammers which the paper had the least chance of getting stuck to each other. You can read more about QWERTY on [Wikipedia](https://en.wikipedia.org/wiki/QWERTY).
...
First is configuration. If your keyboard is designed for a less common language, like Swedish in my case, a layout might not be available by default. In that case, you need to create it yourself. I did it using [Microsoft Keyboard Layout Creator](https://www.microsoft.com/en-us/download/details.aspx?id=22339) You can also use the [design ideas of Dvorak](https://en.wikipedia.org/wiki/Dvorak_Simplified_Keyboard#Overview) to create a custom layout based on any unique typing patterns.

How to change the keyboard layout:

[In Windows 7](https://www.wikihow.com/Change-Keyboard-Layouts-on-Windows-7) [In Windows 10](https://www.windowscentral.com/how-change-your-keyboard-layout-windows-10) [In Mac OS X](https://thetypingcat.com/howto/change-your-keyboard-layout-mac-os-x) [In Linux Ubuntu](https://www.wikihow.com/Change-Keyboard-Layout-in-Ubuntu)
