...
I have chosen to enter [another Minecraft related competition](https://www.planetminecraft.com/contests/robots-minecraft-skin-contest) to challenge myself to do pixel art. Like the last one, where my Pumpkin House got placed 16 out of 56, it is on [Planet Minecraft](https://www.planetminecraft.com), and the theme this time is robots, and I immediately got an idea, helped by a drawing I did perhaps a year ago from imagination of a flying robot. To make it specialize in something, I picture it flying among trees picking fruits and nuts.

## Advantages of my strategy  

Looking briefly at the other contest participants, I see that most of them make what to me looks like either  [androids](https://en.wikipedia.org/wiki/Android_\(robot\)) (robots closely resembling humanoids) or even humans with cybernetic enhancements or suits. That means my functionally designed robot should stand out and I might have an edge in originality. The last competition I entered was judged on three criteria: Originality, presentation and technical skills. Since the format is so limited, only a 64 by 32 pixels png picture, the technical gap is not as hard to overcome, and there are friendly tutorials available on [the competition page](https://www.planetminecraft.com/contests/robots-minecraft-skin-contest).
...
![](/blog/2018-11-25-making-a-minecraft-skin/images/screenshot-from-2018-11-25-17-23-41.png)
...
But I have an unsolved problem: Transparency! The second layer on the head parts are not transparent, the white will cover the head. Slight panic, until I finally cave in and use the tool recommended on the competition page, Planet Minecraft's own skin editor: https://www.planetminecraft.com/pmcskin3d
...
![](/blog/2018-11-25-making-a-minecraft-skin/images/screenshot-from-2018-11-25-17-35-03.png)
...
![](/blog/2018-11-25-making-a-minecraft-skin/images/robot-front.png)
...
![](/blog/2018-11-25-making-a-minecraft-skin/images/robot-back.png)
...
Should animals be within a certain distance, the droid will immediately hang from the nearest branch with its grip claws and power down until the animal has left the hazardous proximity zone. Its programming is an attempt to **extend** [Asimov's three laws of robotics](https://en.wikipedia.org/wiki/Three_Laws_of_Robotics). The extended version could be stated as follows:  

1. It may not injure a human or animal being, or through inaction, allow a human or animal being come to harm  
    

3. It must obey the orders given it, except where such orders would conflict with the first law  
    

5. It only protects its own existence as long as such protection does not conflict with the first or second laws
