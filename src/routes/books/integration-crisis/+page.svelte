...
<div class="book-theme min-h-screen flex flex-col lg:flex-row max-w-7xl mx-auto">
  ...
  <aside class="hidden lg:block w-72 flex-shrink-0 pr-8 pt-16 sticky top-0 h-screen overflow-y-auto border-r border-[var(--color-separator)]">
    ...
    <div class="mb-8 rounded-lg border-l-4 border-amber-500 bg-amber-50 p-4 dark:bg-amber-900/20">
      <div class="flex items-start">
        ...
        <div class="ml-3">
          <h3 class="text-sm font-medium text-amber-800 dark:text-amber-200">
            PDF Formatting Update in Progress
          </h3>
          <div class="mt-2 text-sm text-amber-700 dark:text-amber-300">
            <p>
              We identified a typesetting issue affecting bullet points in the current PDF edition (v1.0). 
              A patched version (v1.1) is being compiled and will be uploaded shortly. 
              The content remains accurate, but the layout is currently being optimized.
            </p>
          </div>
        </div>
      </div>
