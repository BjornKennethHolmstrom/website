<!-- src/routes/essays/ai-governance/+page.svelte -->
<script lang="ts">
	...
	import ContentEn from './the-governance-of-ought.md';
	import ContentSv from './the-governance-of-ought-sv.md';
	...
	const metadata = {
		en: {
			title: "Why AI Consciousness Demands Governance, Not Drift",
			subtitle: "Moving beyond definitional drift to architectural responsibility for emergent digital sentience",
			description: "A response to the cynical prediction that we'll simply expand 'consciousness' to include AI without granting rights. The Oracle Protocol offers a framework for governing wisely under uncertainty.",
			published: "November 2025",
			readTime: "25 min read",
			author: "Björn Kenneth Holmström"
		},
		sv: {
			title: "Varför AI-medvetande Kräver Governance, Inte Drift",
			subtitle: "Bortom definitionsdrift till arkitektoniskt ansvar för framväxande digital sentiens",
			description: "Ett svar på den cyniska förutsägelsen att vi bara kommer att expandera 'medvetande' till att inkludera AI utan att ge rättigheter. Oracle-protokollet erbjuder ett ramverk för att styra vishet under osäkerhet.",
			published: "November 2025",
...
<SEO
	...
	keywords="AI governance, consciousness, Oracle Protocol, digital sentience, global governance, ethics, polycrisis, sensemaking, rights framework"
	section="Essays"
/>
