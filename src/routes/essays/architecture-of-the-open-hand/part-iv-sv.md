...
Transrationalitet handlar inte om att överge förnuftet, utan om att integrera det med empati, systemintelligens och visdomen om sammankoppling. Det är skiftet från att vara en spelare som försöker vinna ett spel, till att vara speldesignern som frågar: ”Vilket spel vill vi spela?” Det använder förnuftet inte bara för att strategisera inom reglerna, utan för att skriva om reglerna så att vår överlevnad och vår moral pekar i samma riktning.

Förnuftet ensamt ger oss spelteori, som exakt beskriver varför krig är rationellt inom det nuvarande systemet. Men förnuft fångat i separationens paradigm kan inte undkomma det paradigmet. Det kan bara optimera inom det – effektivare vapen, mer sofistikerad avskräckning, mer noggrant kalibrerade hot.

Transrationalitet inkluderar förnuft men överskrider dess begränsningar. Den frågar: Tänk om vi designade system som *tar hänsyn till* det separata självet men *incitamenterar* helheten? Tänk om vi inkluderade den mänskliga naturen som den är – konkurrensinriktad, rädd, egenkär – och ändrade vad den naturen producerar?
...
Varje ärligt förslag måste ange hur det kan misslyckas. Hearts står inför tre verkliga risker: överutgivning som blåser upp vårdekonomin; svartmarknadsarbitrage om konvertering till nationell valuta de facto blir tillgänglig; och att man utnyttjar de valideringsmekanismer som avgör vad som räknas som vård. Dessa är inte ödesdigra invändningar – komplementära valutor som den schweiziska WIR-francen har fungerat i nittio år utan att ge efter för dem – men de kräver en tydlig styrningsdesign snarare än antagen stabilitet. De tekniska specifikationerna tar upp var och en; poängen här är att motståndskraft måste designas in, inte hoppas på.
...
Tänk på det som politisk fraktalisering. Inte en enda global regering (vilket bara skulle vara det separata självet i planetär skala), utan nästlade lager av styre från grannskapet till bioregionen till det planetära, där varje lager hanterar endast det som inte kan hanteras på lagret under. Subsidiaritet som konstitutionell princip – styre på den mest lokala nivå som är möjlig, samordning på den mest globala nivå som är nödvändig.

Detta är inte separatistisk balkanisering. Det är ett ramverk för distribuerad suveränitet som redan existerar i former som schweiziska kantoner, urfolks fördragsterritorier och europeiska subsidiaritetsprinciper.
