<!-- src/routes/essays/mycelial-economy/+page.svelte -->
<script lang="ts">
	...
	const metadata = {
		en: {
			title: "The Mycelial Economy: From Conditional Transactions to Unconditional Flow",
			subtitle: "A Vision of Economics as Living System",
			description: "What if our economy worked like a forest instead of a machine? This essay explores the fundamental difference between conditional exchange and unconditional circulation, grounded in lived experience.",
			published: "November 2024",
			readTime: "25 min read",
			author: "Björn Kenneth Holmström"
		},
		sv: {
			title: "Den myceliala ekonomin: Från villkorliga transaktioner till ovillkorligt flöde",
			subtitle: "En vision av ekonomi som levande system",
			description: "Vad om vår ekonomi fungerade som en skog istället för en maskin? Denna essä utforskar den grundläggande skillnaden mellan villkorligt utbyte och ovillkorlig cirkulation, grundad i levd erfarenhet.",
			published: "November 2024",
...
<SEO
	...
	keywords="economics, gift economy, mycelium, regeneration, systems thinking, vault, flow, unconditional, basque country"
	section="Essays"
/>
				...
				<div class="flex items-center gap-3">
					...
					<div>
						...
						<p class="text-sm opacity-70" style="color: var(--color-page-text);">
							{$language === 'en' 
								? 'The practical protocol for conscious capital' 
								: 'Det praktiska protokollet för medvetet kapital'}
						</p>
					</div>
				</div>
			</a>
