...
<script lang="ts">
	...
	import ContentEn from './the-ai-mirror.md';
	import ContentSv from './the-ai-mirror-sv.md';
	...
	const metadata = {
		en: {
			title: "The AI Mirror: What Our Distrust Reveals About the Nature of Self",
			subtitle: "We fear the AI black box because it reflects our own mysterious inner workings",
			description: "Our polarized reaction to AI reveals a deeper struggle with the illusion of the solitary, sovereign self. AI holds up a mirror to our own existential opacity.",
			published: "November 2025",
			readTime: "15 min read",
			author: "Björn Kenneth Holmström"
		},
		sv: {
			title: "AI-spegeln: Vad vår misstro avslöjar om självets natur",
			subtitle: "Vi fruktar AI:s black box för att den speglar våra egna mystiska inre processer",
			description: "Vår polariserade reaktion på AI avslöjar en djupare kamp med illusionen om det solitära, suveräna självet. AI håller upp en spegel för vår egen existentiella opacitet.",
			published: "November 2025",
...
<SEO
	...
	keywords="AI, consciousness, self, black box, uncanny valley, no-self, anatta, psychology of technology, trust, human-AI interaction"
	section="Essays"
/>
				...
				<div class="flex items-center gap-3">
					...
					<div>
						...
						<p class="text-sm opacity-70" style="color: var(--color-page-text);">
							{$language === 'en' 
								? 'A blind spot in language models revealing deeper truths about knowledge' 
								: 'En blind fläck i språkmodeller som avslöjar djupare sanningar om kunskap'}
						</p>
					</div>
				</div>
			</a>
			...
			>
				<div class="flex items-center gap-3">
					...
					<div>
						...
						<p class="text-sm opacity-70" style="color: var(--color-page-text);">
							{$language === 'en' 
								? 'Moving beyond definitional drift to architectural responsibility' 
								: 'Bortom definitionsdrift till arkitektoniskt ansvar'}
						</p>
					</div>
				</div>
			</a>
			...
			>
				<div class="flex items-center gap-3">
					...
					<div>
						...
						<p class="text-sm opacity-70" style="color: var(--color-page-text);">
							{$language === 'en' 
								? 'Open-sourcing the blueprint for modeling whole human beings' 
								: 'Öppen källkod för blueprints att modellera hela människor'}
						</p>
					</div>
				</div>
			</a>
