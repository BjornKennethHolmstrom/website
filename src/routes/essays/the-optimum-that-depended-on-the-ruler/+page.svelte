<!-- src/routes/essays/the-optimum-that-depended-on-the-ruler/+page.svelte -->
<script lang="ts">
	...
	// --- IMPORT RAW MARKDOWN ---
	import ContentEnRaw from './the-optimum-that-depended-on-the-ruler.md?raw';
	import ContentSvRaw from './the-optimum-that-depended-on-the-ruler-sv.md?raw';
	...
	const metadata = {
		en: {
			...
			description: 'A computational exploration that started from a metaphor, produced a clean result, and then dissolved when a robustness check changed the definition of coordination capacity.',
		...
		sv: {
			...
			description: 'Ett beräkningsinriktat utforskande som började i en metafor, gav ett rent resultat, och sedan upplöstes när en robusthetskontroll ändrade definitionen av koordinationskapacitet.',
...
<SEO
	...
	keywords="governance, subsidiarity, polycentric, coordination, simulation, modeling, Ashby's law, allocation, robustness check, transition valley, variety, accountability"
	section="Essays"
/>
