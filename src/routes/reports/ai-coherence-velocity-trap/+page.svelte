<!-- src/routes/reports/ai-coherence-velocity-trap/+page.svelte -->
<script lang="ts">
  ...
  import CoherenceVelocityTrapEn from './sections/01-coherence-velocity-trap.en.md';

  // 2. Structural Mechanisms
  import StructuralMechanismsEn from './sections/02-structural-mechanisms.en.md';

  // 3. Building Adaptive Coherence
  import BuildingAdaptiveCoherenceEn from './sections/03-building-adaptive-coherence.en.md';
  ...
  const contentMap = [
    ...
    {
      id: 'coherence-velocity-trap',
      title: '1. The Coherence–Velocity Trap',
      comp: CoherenceVelocityTrapEn,
    },
    {
      id: 'structural-mechanisms',
      title: '2. Structural Mechanisms: How Frontier AI Organisations Become Blind',
      comp: StructuralMechanismsEn,
    },
    {
      id: 'building-adaptive-coherence',
      title: '3. What Building Adaptive Coherence Would Look Like',
      comp: BuildingAdaptiveCoherenceEn,
    },
    {
      id: 'immune-system',
      title: '4. The Political Immune System: The Deployment Imperative',
      comp: ImmuneSystemEn,
    },
    {
      id: 'first-step',
      title: '5. A Concrete First Step: The AI Commons Governance Protocol',
      comp: FirstStepEn,
    },
    {
      id: 'coda',
      title: '6. Coda: The Alignment Frontier',
      comp: CodaEn,
    },
    {
      id: 'appendix-a',
  ...
  const metadata = {
    ...
    subtitle:
      'Why the race to AGI cannot be won by any single governance architecture — and what a multi‑scalar framework would require',
    description:
      'Frontier AI organizations are not merely technology companies — they are governance systems under extreme velocity conditions. This report diagnoses a Coherence–Velocity Trap produced by the capital architecture, founder‑centric compression, and safety‑washing mechanisms, and proposes an AI Commons Governance Protocol as the concrete first step.',
  };

  const ui = {
    tag: 'Organizational Report · AI Governance',
...
<div class="min-h-screen flex flex-col lg:flex-row max-w-7xl mx-auto">
  ...
  <div class="lg:hidden flex flex-wrap items-center justify-between gap-3 px-4 pt-4 pb-2 border-b border-[var(--color-separator)] mb-6">
    <!-- PDF download -->
    <a
      href="/reports/ai-coherence-velocity-trap-en.pdf"
      download
    ...
    <button
      onclick={() => {
        const cite = 'Holmström, B. K. (2026). The Coherence–Velocity Trap: A Cybernetic Analysis of Frontier AI Governance. Organizational Report.';
