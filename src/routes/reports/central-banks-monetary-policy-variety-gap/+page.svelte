<!-- src/routes/reports/central-banks-monetary-policy-variety-gap/+page.svelte -->
<script lang="ts">
  ...
  import MonetaryPolicyVarietyGapEn from './sections/01-monetary-policy-variety-gap.en.md';

  // 2. Structural Mechanisms
  import StructuralMechanismsEn from './sections/02-structural-mechanisms.en.md';

  // 3. Building Requisite Monetary Governance
  import BuildingRequisiteGovernanceEn from './sections/03-building-requisite-monetary-governance.en.md';
  ...
  const contentMap = [
    ...
    {
      id: 'monetary-policy-variety-gap',
      title: '1. The Monetary Policy Variety Gap',
      comp: MonetaryPolicyVarietyGapEn,
    },
    {
      id: 'structural-mechanisms',
      title: '2. Structural Mechanisms: How Central Banks Become Blind to the Economies They Govern',
      comp: StructuralMechanismsEn,
    },
    {
      id: 'building-requisite-governance',
      title: '3. What Building Requisite Monetary Governance Would Look Like',
      comp: BuildingRequisiteGovernanceEn,
    },
    {
      id: 'immune-system',
      title: '4. The Political Immune System: The Pretence of Knowledge',
      comp: ImmuneSystemEn,
    },
    {
      id: 'first-step',
      title: '5. A Concrete First Step: The Monetary Policy Distributional Impact Assessment',
      comp: FirstStepEn,
    },
    {
      id: 'coda',
      title: '6. Coda: The Engineers at the Table',
      comp: CodaEn,
    },
    {
      id: 'appendix-a',
  ...
  const metadata = {
    ...
    subtitle:
      'A cybernetic diagnosis of the most sophisticated governance institutions on earth — and how to build monetary architectures that can perceive what they currently exclude',
    description:
      'Central banks are the most explicitly control‑theoretic governance institutions ever built — yet their models cannot perceive the financial, distributional, fiscal, and ecological dimensions that determine the outcomes of their actions. This report diagnoses a Monetary Policy Variety Gap and proposes a Distributional Impact Assessment as the concrete first step.',
  };

  const ui = {
    tag: 'Organizational Report · Central Banks',
...
<div class="min-h-screen flex flex-col lg:flex-row max-w-7xl mx-auto">
  ...
  <div class="lg:hidden flex flex-wrap items-center justify-between gap-3 px-4 pt-4 pb-2 border-b border-[var(--color-separator)] mb-6">
    <!-- PDF download -->
    <a
      href="/reports/central-banks-monetary-policy-variety-gap-en.pdf"
      download
    ...
    <button
      onclick={() => {
        const cite = 'Holmström, B. K. (2026). The Monetary Policy Variety Gap: Why Central Banks Cannot See the Economies They Are Steering. Organizational Report.';
