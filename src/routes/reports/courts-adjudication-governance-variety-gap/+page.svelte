<!-- src/routes/reports/courts-adjudication-governance-variety-gap/+page.svelte -->
<script lang="ts">
  ...
  import AdjudicationGovernanceVarietyGapEn from './sections/01-adjudication-governance-variety-gap.en.md';

  // 2. Structural Mechanisms
  import StructuralMechanismsEn from './sections/02-structural-mechanisms.en.md';

  // 3. Building Requisite Judicial Governance
  import BuildingRequisiteGovernanceEn from './sections/03-building-requisite-judicial-governance.en.md';
  ...
  const contentMap = [
    ...
    {
      id: 'adjudication-governance-variety-gap',
      title: '1. The Adjudication–Governance Variety Gap',
      comp: AdjudicationGovernanceVarietyGapEn,
    },
    {
      id: 'structural-mechanisms',
      title: '2. Structural Mechanisms: How Courts Become Blind to the Systems They Govern',
      comp: StructuralMechanismsEn,
    },
    {
      id: 'building-requisite-governance',
      title: '3. What Building Requisite Judicial Governance Would Look Like',
      comp: BuildingRequisiteGovernanceEn,
    },
    {
      id: 'immune-system',
      title: '4. The Political Immune System: Adversarial Epistemology',
      comp: ImmuneSystemEn,
    },
    {
      id: 'first-step',
      title: '5. A Concrete First Step: The Systemic Effects Registry',
      comp: FirstStepEn,
    },
    {
      id: 'coda',
      title: '6. Coda: The Retrospective Stabiliser',
      comp: CodaEn,
    },
    {
      id: 'appendix-a',
  ...
  const metadata = {
    ...
    subtitle:
      'A cybernetic diagnosis of the most procedurally sophisticated governance institution — and how to build judicial architectures that can perceive the systemic consequences of individual decisions',
    description:
      'Courts are the most procedurally sophisticated governance institutions ever built — yet their observation architecture is calibrated to the individual dispute and structurally blind to the systemic consequences of their decisions. This report diagnoses an Adjudication–Governance Variety Gap and proposes a Systemic Effects Registry as the concrete first step.',
  };

  const ui = {
    tag: 'Organizational Report · Courts & Legal Systems',
...
<div class="min-h-screen flex flex-col lg:flex-row max-w-7xl mx-auto">
  ...
  <div class="lg:hidden flex flex-wrap items-center justify-between gap-3 px-4 pt-4 pb-2 border-b border-[var(--color-separator)] mb-6">
    <!-- PDF download -->
    <a
      href="/reports/courts-adjudication-governance-variety-gap-en.pdf"
      download
    ...
    <button
      onclick={() => {
        const cite = 'Holmström, B. K. (2026). The Adjudication–Governance Variety Gap: Why Courts Cannot See the Systems They Govern. Organizational Report.';
