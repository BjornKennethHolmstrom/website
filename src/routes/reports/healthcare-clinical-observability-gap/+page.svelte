<!-- src/routes/reports/healthcare-clinical-observability-gap/+page.svelte -->
<script lang="ts">
  ...
  import ClinicalObservabilityGapEn from './sections/01-clinical-observability-gap.en.md';

  // 2. Structural Mechanisms
  import StructuralMechanismsEn from './sections/02-structural-mechanisms.en.md';

  // 3. Building Clinical Observability
  import BuildingClinicalObservabilityEn from './sections/03-building-clinical-observability.en.md';
  ...
  import AppendixFEn from './sections/07-appendix-f.en.md';
  ...
  const contentMap = [
    ...
    {
      id: 'clinical-observability-gap',
      title: '1. The Clinical Observability Gap',
      comp: ClinicalObservabilityGapEn,
    },
    {
      id: 'structural-mechanisms',
      title: '2. Structural Mechanisms: How Healthcare Systems Become Blind to the Patient',
      comp: StructuralMechanismsEn,
    },
    {
      id: 'building-clinical-observability',
      title: '3. What Building Clinical Observability Would Look Like',
      comp: BuildingClinicalObservabilityEn,
    },
    {
      id: 'immune-system',
      title: '4. The Political Immune System: The Administrative Imperative',
      comp: ImmuneSystemEn,
    },
    {
      id: 'first-step',
      title: '5. A Concrete First Step: The Clinical Observability Audit and the Information Sandbox',
      comp: FirstStepEn,
    },
    {
      id: 'coda',
      title: '6. Coda: The Patient in the System',
      comp: CodaEn,
    },
    {
      id: 'appendix-a',
    ...
    {
      id: 'appendix-f',
      title: 'Appendix F: Key Concepts and Abbreviations',
      comp: AppendixFEn,
    },
  ];
  ...
  const metadata = {
    ...
    subtitle:
      'A cybernetic diagnosis of modern healthcare governance — and how to build systems that can see the patient while managing the population',
    description:
      'Healthcare systems are becoming more organisationally sophisticated while becoming less clinically coherent. This report diagnoses a Clinical Observability Gap produced by payment architectures, documentation burdens, and the Standardisation–Signal Destruction Spiral, and proposes a Clinical Observability Audit and an Information Sandbox as the concrete first step.',
  };

  const ui = {
    tag: 'Organizational Report · Healthcare',
...
<SEO
  title="{metadata.title} | Organizational Report"
...
<div class="min-h-screen flex flex-col lg:flex-row max-w-7xl mx-auto">
  ...
  <div class="lg:hidden flex flex-wrap items-center justify-between gap-3 px-4 pt-4 pb-2 border-b border-[var(--color-separator)] mb-6">
    <!-- PDF download -->
    <a
      href="/reports/healthcare-clinical-observability-gap-en.pdf"
      download
    ...
    <button
      onclick={() => {
        const cite = 'Holmström, B. K. (2026). The Clinical Observability Gap: Why Healthcare Systems Lose the Signal Between the Bedside and the Boardroom. Organizational Report.';
