<!-- src/routes/reports/uk-control-mirage/+page.svelte -->
<script lang="ts">
  ...
  import ControlMirage from './sections/01-control-mirage.en.md';
  import Diagnosis from './sections/02-diagnosis.en.md';
  import BuildingAlignment from './sections/03-building-alignment.en.md';
  ...
  import Trailblazer2 from './sections/06-trailblazer-2.0.en.md';
  ...
  const contentMap = [
    ...
    {
      id: 'control-mirage',
      title: '1. The Control Mirage',
      comp: ControlMirage,
    },
    {
      id: 'diagnosis',
      title: '2. The Control-Delivery Mismatch: A New Diagnosis',
      comp: Diagnosis,
    },
    {
      id: 'building-alignment',
      title: '3. What Building Control-Delivery Alignment Would Look Like',
      comp: BuildingAlignment,
    },
    {
      id: 'political-immune',
      title: '4. The Political Immune System: Why the UK Centralises',
      comp: PoliticalImmune,
    },
    {
      id: 'transition-architecture',
      title: '5. Working with the Grain: Transition Architecture for the UK',
      comp: TransitionArchitecture,
    },
    {
      id: 'trailblazer',
      title: '6. A Concrete First Step: Trailblazer Regions 2.0',
      comp: Trailblazer2,
    },
    {
      id: 'coda',
      title: '7. Coda: From Centralising to Connecting',
      comp: Coda,
    },
    {
      id: 'appendix-a',
  ...
  const ui = {
    tag: 'Country Report · United Kingdom',
...
<div class="min-h-screen flex flex-col lg:flex-row max-w-7xl mx-auto">
  ...
  <aside class="hidden lg:block w-72 flex-shrink-0 pr-8 pt-16 sticky top-0 h-screen overflow-y-auto">
    ...
    <div class="mb-8 pb-8 border-b border-[var(--color-separator)]">
      ...
      <div class="space-y-3">
        <a
          href="/reports/uk-control-mirage-en.pdf"
          download
  ...
  <main class="flex-1 min-w-0 px-4 pt-16 pb-24">
    ...
    <div class="mt-24 pt-8 border-t border-[var(--color-separator)]">
      <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <button
          onclick={() => {
            const cite = 'Holmström, B. K. (2026). The Control Mirage: Why Britain\'s Centralised Power Produces Fragmented Outcomes. Strategic Country Report.';
