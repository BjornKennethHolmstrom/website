<script lang="ts">
  ...
  import ContentEn from '$lib/content/syntheses/the-blindness-of-power.md';
  import ContentSv from '$lib/content/syntheses/the-blindness-of-power-sv.md';

  const SLUG = 'the-blindness-of-power';
  ...
  const meta = {
    en: {
      ...
      description:
        'A global synthesis on the structural limits of authoritarian, populist, and strongman governance. It demonstrates that the Control‑Blindness‑Shock Loop is not a Russian or Chinese anomaly—it is the signature of any architecture that destroys its own sensors.',
      audience: 'Geopolitical analysts, democracy advocates, and those watching the rise of authoritarian governance.',
      pdf: '/syntheses/the-blindness-of-power.pdf',
    },
    sv: {
      title: 'Maktens blindhet',
      subtitle: 'Varför kontrollbesatt styrning misslyckas – och vad det innebär för varje regim',
      description:
        'En global syntes om de strukturella begränsningarna hos auktoritärt, populistiskt och starkmansstyre. Den visar att Kontroll‑Blindhet‑Chock‑slingan inte är en rysk eller kinesisk anomali – den är signaturen för varje arkitektur som förstör sina egna sensorer.',
      audience: 'Geopolitiska analytiker, demokratiförespråkare och de som ser auktoritärt styre växa fram.',
      pdf: '/syntheses/the-blindness-of-power-sv.pdf',
    },
  };
...
<div class="max-w-3xl mx-auto px-4 py-16">
  ...
  <header class="mb-12 text-center">
    <span
      class="inline-block px-3 py-1 text-xs font-medium tracking-wide uppercase rounded-full bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200 mb-4"
    >
