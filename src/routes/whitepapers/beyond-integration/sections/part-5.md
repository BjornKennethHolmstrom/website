...
**If A=unsafe, B=cascading failure, C=no context:**
→ **Stabilization Track** (traditional psychiatry)
- Medication, hospitalization, safety
- Goal: Prevent harm, restore baseline
- Duration: Until stable enough for next phase

**If A=safe, B=mixed/temporary dips, C=developmental:**
→ **Integration Support Track** (NEW)
...
**If A=safe, B=maintaining, C=advanced practice:**
→ **Development Enhancement Track** (NEW)
...
→ Gets diagnosed (mentally ill)
→ Receives treatment (medication, therapy)
→ Treatment "works" (symptoms suppressed, can function)
→ Gets economic support tied to diagnosis (disability, sick leave)
→ Survival depends on maintaining patient status
→ **Cannot explore whether diagnosis is still accurate**
→ **Cannot question medication necessity**
→ **Cannot investigate what actually happened**
→ **Trapped**
...
**Core principle:**
Every human receives unconditional economic support sufficient for:
- Housing
- Food
- Healthcare
...
**Person has crisis:**
→ Receives support (intervention, community, framework)
→ Gets AUBI (survival secured regardless)
→ Explores what happened (with professional support)
→ Questions medication (safely, with monitoring)
→ Investigates own consciousness (over years if needed)
→ **Can seek truth without risking survival**
...
**If yes:** Support the request
**If no:** Nudge toward integration, or refuse if harmful
...
**Scenario 1: Consciousness Exploration with Support**
User: "I'm questioning whether I need medication. I have therapist, meditation teacher, years of practice. Want to explore gradually."
...
**Scenario 2: Crisis Without Support**
User: "Reality is dissolving, I'm seeing through everything, I should stop my meds and embrace the void."
...
**Scenario 3: Developmental Questioning**
User: "The six-domain model seems to assume separation. What about nondual recognition?"
