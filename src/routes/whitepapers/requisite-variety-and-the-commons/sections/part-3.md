...
![Simulation output: four rows of panels. Top row: resource stock trajectories for all five architectures over 30 years. Middle left: requisite variety coverage diagram showing which architectures observe which disturbance frequency bands. Middle right: extraction inequality (Gini coefficient) over time. Bottom left: slow variable tracking — 24-month rolling mean of stock as proxy for trend detection. Bottom right: summary bar chart of mean stock, collapse risk, and extraction inequality.](/whitepapers/images/requisite-variety-and-the-commons/ggf-simulator-v6.png)
