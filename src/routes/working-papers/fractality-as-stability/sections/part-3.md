...
![Simulation output: four rows of panels showing heatmaps, mean stability trace, representative node traces, and bottom-row metrics including deficit bars, control effort bars, and frequency coverage diagram.](/working-papers/images/fractality-as-stability/ggf-simulator-v4.png)
