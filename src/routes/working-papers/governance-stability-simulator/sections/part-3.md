...
![Simulation output showing four panels: heatmaps comparing node stability over time for both architectures, individual node traces for crisis and healthy nodes, cumulative deficit per node, and control signal comparison for a crisis node.](/working-papers/images/governance-simulator/governance-simulator-v3.png)
