...
### 3.1 Observationskanalens försämring → Observationsarkitekturens effektiva dimensionalitet (V_o)
...
**Osäkerhet.** Låg. Oscillationsdynamik är direkt mätbar från offentligt tillgängliga tidsseriedata för de flesta styrsystem. Den främsta utmaningen är att skilja endogen oscillation (genererad av styrningsarkitekturens egna responsdynamik) från exogen volatilitet (genererad av externa chocker), vilket kräver domänspecifik kausalanalys.
...
| Återkopplingsmisslyckande | σ | Sammansatt: transparens, visselblåsarskydd, mediefrihet, revisionsoberoende | Måttlig | 1 (Epistemisk) |
| Immunsystemaktivitet | 1 − immunpermeabilitet | Kvot mellan strukturellt implementerade och annonserade reformer | Måttlig–Hög | 2 (Respons) |
