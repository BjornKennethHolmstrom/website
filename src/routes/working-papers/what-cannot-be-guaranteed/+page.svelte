<script lang="ts">
  ...
  const contentMap = [
    ...
    { id: 'section-02',  titleEn: '2. Three limits, three sources, and why they do not reduce to one', titleSv: '2. Tre gränser, tre källor, och varför de inte reduceras till en' },
    { id: 'section-03',  titleEn: '3. The first limit: a system cannot certify the basis of its own correction', titleSv: '3. Den första gränsen: ett system kan inte certifiera grunden för sin egen korrigering' },
    { id: 'section-04',  titleEn: '4. The registered demonstration: a certification crisis',           titleSv: '4. Den registrerade demonstrationen: en certifieringskris' },
    { id: 'section-05',  titleEn: '5. The second limit: no one can decide from outside whether a reform converges', titleSv: '5. Den andra gränsen: ingen kan utifrån avgöra om en reform konvergerar' },
    { id: 'section-06',  titleEn: '6. The third limit: no architecture is right without a world',       titleSv: '6. Den tredje gränsen: ingen arkitektur är rätt utan en värld' },
    { id: 'section-07',  titleEn: '7. From guarantee to hedge: what the three limits buy',              titleSv: '7. Från garanti till gardering: vad de tre gränserna ger' },
    { id: 'section-08',  titleEn: '8. Integration with the series',                                     titleSv: '8. Integration med serien' },
    { id: 'section-09',  titleEn: '9. What this paper does not show',                                   titleSv: '9. Vad denna artikel inte visar' },
    { id: 'appendix-a',  titleEn: 'Appendix A: Formal development and simulation',                      titleSv: 'Appendix A: Formell utveckling och simulering' },
    { id: 'appendix-b',  titleEn: 'Appendix B: The undecidability reduction',                           titleSv: 'Appendix B: Oavgörbarhetsreduktionen' },
  ];

  // --- 4. UI TRANSLATIONS & METADATA ---
  const ui = {
    en: {
      tag: 'Working Paper · Series XXII',
      seriesNote: 'This is the twenty‑second paper in the Governance as Engineering series. It examines three demands for assurance and shows each fails for its own reason.',
      ...
      contextIntro: 'This paper examines three demands for assurance — from inside, from outside, and before the world — and shows that each fails for a reason of its own. A registered minimal model demonstrates a mechanism in which a corrupted certification kernel makes an institution\'s health indicators improve while resources are systematically misallocated.',
      contextOutro: 'The paper refuses the unification the series\' previous paper invites, declares its two formal results shallow, and keeps the certification incompleteness as a structural diagnosis. Five registered predictions fail; one post‑hoc mechanism is re‑registered and confirmed. The design consequence: an institution cannot monitor its own certification kernel with instruments that depend on that kernel.',
    ...
    sv: {
      tag: 'Arbetsdokument · Serie XXII',
      seriesNote: 'Detta är den tjugoandra rapporten i serien Styrning som ingenjörskonst. Den undersöker tre krav på garanti och visar att vart och ett misslyckas av sitt eget skäl.',
      ...
      contextIntro: 'Denna artikel undersöker tre krav på garanti — inifrån, utifrån och före världen — och visar att vart och ett misslyckas av sitt eget skäl. En registrerad minimal modell demonstrerar en mekanism där en korrupt certifieringskärna får institutionens hälsoindikatorer att förbättras medan resurser systematiskt felallokeras.',
      contextOutro: 'Artikeln vägrar den unifiering som seriens föregående rapport inbjuder till, förklarar sina två formella resultat grunda och behåller certifieringsoförmågan som en strukturell diagnos. Fem registrerade förutsägelser misslyckas; en post‑hoc‑mekanism återregistreras och bekräftas. Designkonsekvensen: en institution kan inte övervaka sin egen certifieringskärna med instrument som är beroende av den kärnan.',
  ...
  const metadata = {
    en: {
      ...
      description: 'Examines three demands for assurance and shows each fails for its own reason. A corrupted certification kernel makes institutions look healthier, not sicker. Paper XXII in the Governance as Engineering series.',
    },
    sv: {
      ...
      description: 'Undersöker tre krav på garanti och visar att vart och ett misslyckas av sitt eget skäl. En korrupt certifieringskärna får institutioner att se friskare ut. Rapport XXII i serien Styrning som ingenjörskonst.',
    },
  };
  ...
  let pdfFilename = $derived(currentLang === 'sv' ? 'what-cannot-be-guaranteed-sv.pdf' : 'what-cannot-be-guaranteed.pdf');
  ...
  function copyCitation() {
    const citation = currentLang === 'sv'
      ? `Holmström, B. K. (2026). Vad som inte kan garanteras: Certifieringsoförmåga, reformavgörbarhet och frånvaron av en universell arkitektur. Styrning som ingenjörskonst, Rapport XXII.`
      : `Holmström, B. K. (2026). What Cannot Be Guaranteed: Certification incompleteness, reform undecidability, and the absence of a universal architecture. Governance as Engineering, Paper XXII.`;
