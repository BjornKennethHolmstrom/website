<script lang="ts">
  ...
  const contentMap = [
    ...
    { id: 'section-01',  titleEn: '1. The lifecycle question',                                      titleSv: '1. Livscykelfrågan' },
    { id: 'section-02',  titleEn: '2. Learning is not adaptation',                                   titleSv: '2. Lärande är inte anpassning' },
    { id: 'section-03',  titleEn: '3. A model where learning breaks coupling',                      titleSv: '3. En modell där lärande bryter kopplingen' },
    { id: 'section-04',  titleEn: '4. Meta‑learning must close',                                    titleSv: '4. Meta‑lärande måste stängas' },
    { id: 'section-05',  titleEn: '5. Closure requires invariants',                                 titleSv: '5. Stängning kräver invarianter' },
    { id: 'section-06',  titleEn: '6. Persistence is not the goal — sunsetting',                    titleSv: '6. Beständighet är inte målet — avveckling' },
    { id: 'section-07',  titleEn: '7. The unifying structure',                                      titleSv: '7. Den förenande strukturen' },
    { id: 'section-08',  titleEn: '8. What this re‑grounds, and what it does not show',              titleSv: '8. Vad detta återgrundar, och vad det inte visar' },
    { id: 'section-09',  titleEn: '9. Method and confidence',                                        titleSv: '9. Metod och konfidens' },
    { id: 'appendix-a',  titleEn: 'Appendix A: The learning/adaptation model',                      titleSv: 'Appendix A: Modellen för lärande/anpassning' },
  ];

  // --- 4. UI TRANSLATIONS & METADATA ---
  const ui = {
    en: {
      tag: 'Working Paper · Series XXI',
      seriesNote: 'This is the twenty‑first paper in the Governance as Engineering series. It traces the lifecycle of a bounded controller.',
      ...
      contextIntro: 'The series has built from static factorization through dynamics to control under change. This paper takes the last step: the lifecycle of a governance architecture — how it learns, when learning stops helping, and when the architecture itself should end.',
      contextOutro: 'Three separations organize it. Learning is not adaptation: a registered minimal model shows the map improving while the coupling degrades. Meta‑learning is not free: a bounded hierarchy of learning rules must close on invariants. And persistence is not the goal: the terminal adaptive act may be to end or transfer the coupling rather than to continue.',
    ...
    sv: {
      tag: 'Arbetsdokument · Serie XXI',
      seriesNote: 'Detta är den tjugoförsta rapporten i serien Styrning som ingenjörskonst. Den spårar livscykeln hos en begränsad regulator.',
      ...
      contextIntro: 'Serien har byggts från statisk faktorisering genom dynamik till kontroll under förändring. Denna artikel tar det sista steget: livscykeln för en styrningsarkitektur — hur den lär sig, när lärandet slutar hjälpa och när arkitekturen själv bör ta slut.',
      contextOutro: 'Tre separationer organiserar den. Lärande är inte anpassning: en registrerad minimal modell visar kartan förbättras medan kopplingen försämras. Meta‑lärande är inte fritt: en begränsad hierarki av inlärningsregler måste stängas på invarianter. Och beständighet är inte målet: den terminala adaptiva handlingen kan vara att avsluta eller överföra kopplingen snarare än att fortsätta.',
  ...
  const metadata = {
    en: {
      ...
      description: 'Traces the lifecycle of a governance architecture: learning can break coupling, meta‑learning must close on invariants, and the terminal adaptive act may be to end rather than persist. Paper XXI in the Governance as Engineering series.',
    },
    sv: {
      title: 'När man ska sluta lära sig, och när man ska sluta',
      subtitle: 'Lärande, anpassning och livscykeln hos en begränsad regulator',
      description: 'Spårar livscykeln för en styrningsarkitektur: lärande kan bryta kopplingen, meta‑lärande måste stängas på invarianter, och den terminala adaptiva handlingen kan vara att avsluta snarare än att bestå. Rapport XXI i serien Styrning som ingenjörskonst.',
    },
  };
  ...
  let pdfFilename = $derived(currentLang === 'sv' ? 'when-to-stop-learning-sv.pdf' : 'when-to-stop-learning.pdf');
  ...
  function copyCitation() {
    const citation = currentLang === 'sv'
      ? `Holmström, B. K. (2026). När man ska sluta lära sig, och när man ska sluta: Lärande, anpassning och livscykeln hos en begränsad regulator. Styrning som ingenjörskonst, Rapport XXI.`
      : `Holmström, B. K. (2026). When to Stop Learning, and When to Stop: Learning, adaptation, and the lifecycle of a bounded controller. Governance as Engineering, Paper XXI.`;
